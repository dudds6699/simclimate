...
#nice little shifting thing my sister found

#bellow here is just the map stuff in its terrible glory
initialize = () ->
    mapOptions = {
...
recalculateCall = (collection, cssClass) ->
    for it in collection
        request = $.get '/home/pointmover?y=' + it.coords[0] + "&x=" + it.coords[1] , (data) ->
